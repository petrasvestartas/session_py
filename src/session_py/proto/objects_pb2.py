...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_COMPONENT']._serialized_end=310
  _globals['_OBJECTS']._serialized_start=313
  _globals['_OBJECTS']._serialized_end=944
