...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ELEMENTFEATURE']._serialized_end=212
  _globals['_ELEMENT']._serialized_start=215
  _globals['_ELEMENT']._serialized_end=468
