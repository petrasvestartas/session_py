...
def test_mesh_constructor():
    ...
    MINI_CHECK(len(sstr) > 0)
    MINI_CHECK(len(srepr) > 0)
...
def test_mesh_from_lines():
    ...
    lines = [
        Line.from_points(
            Point(4.948083, -0.149798, 1.00765), Point(4.395544, -0.996413, 1.196018)
        ),
        Line.from_points(
            Point(3.866593, 0.371225, 1.376346), Point(4.567265, 0.584361, 1.137476)
        ),
        Line.from_points(
            Point(3.915298, -0.157402, 1.359741), Point(3.282977, -0.051356, 1.575309)
        ),
        Line.from_points(
            Point(4.286215, -0.224964, 1.23329), Point(3.607284, -0.987075, 1.464748)
        ),
        Line.from_points(
            Point(3.744351, 0.971574, 1.41802), Point(3.266367, 0.841359, 1.580972)
        ),
        Line.from_points(
            Point(4.567265, 0.584361, 1.137476), Point(4.948083, -0.149798, 1.00765)
        ),
        Line.from_points(
            Point(4.395544, -0.996413, 1.196018), Point(3.607284, -0.987075, 1.464748)
        ),
        Line.from_points(
            Point(3.915298, -0.157402, 1.359741), Point(4.286215, -0.224964, 1.23329)
        ),
        Line.from_points(
            Point(3.282977, -0.051356, 1.575309), Point(3.266367, 0.841359, 1.580972)
        ),
        Line.from_points(
            Point(3.744351, 0.971574, 1.41802), Point(3.866593, 0.371225, 1.376346)
        ),
    ]
...
def test_mesh_geometric_properties():
    ...
    MINI_CHECK(
        TOLERANCE.is_point_close(
            centroids[0], Point(0.878115294937453, 0.0, 1.420820393249937)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_point_close(
            centroids[1], Point(1.420820393249937, 0.878115294937453, 0.0)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_point_close(
            centroids[2], Point(0.0, 1.420820393249937, 0.878115294937453)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_point_close(
            centroids[3], Point(0.878115294937453, 0.0, -1.420820393249937)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_point_close(
            centroids[4], Point(0.0, 1.420820393249937, -0.878115294937453)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_point_close(
            centroids[5], Point(0.0, -1.420820393249937, 0.878115294937453)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_point_close(
            centroids[6], Point(1.420820393249937, -0.878115294937453, 0.0)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_point_close(
            centroids[7], Point(0.0, -1.420820393249937, -0.878115294937453)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_point_close(
            centroids[8], Point(-1.420820393249937, 0.878115294937453, 0.0)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_point_close(
            centroids[9], Point(-0.878115294937453, 0.0, 1.420820393249937)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_point_close(
            centroids[10], Point(-0.878115294937453, 0.0, -1.420820393249937)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_point_close(
            centroids[11], Point(-1.420820393249937, -0.878115294937453, 0.0)
        )
    )
    ...
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            face_normals[0], Vector(0.5257311121191336, 0.0, 0.8506508083520400)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            face_normals[1], Vector(0.8506508083520400, 0.5257311121191336, 0.0)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            face_normals[2], Vector(0.0, 0.8506508083520400, 0.5257311121191336)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            face_normals[3], Vector(0.5257311121191336, 0.0, -0.8506508083520400)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            face_normals[4], Vector(0.0, 0.8506508083520400, -0.5257311121191336)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            face_normals[5], Vector(0.0, -0.8506508083520400, 0.5257311121191336)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            face_normals[6], Vector(0.8506508083520400, -0.5257311121191336, 0.0)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            face_normals[7], Vector(0.0, -0.8506508083520400, -0.5257311121191336)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            face_normals[8], Vector(-0.8506508083520400, 0.5257311121191336, 0.0)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            face_normals[9], Vector(-0.5257311121191336, 0.0, 0.8506508083520400)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            face_normals[10], Vector(-0.5257311121191336, 0.0, -0.8506508083520400)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            face_normals[11], Vector(-0.8506508083520400, -0.5257311121191336, 0.0)
        )
    )
    ...
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            vertex_normals[1], Vector(0.0, 0.3568220897730899, 0.9341723589627158)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            vertex_normals[2], Vector(0.0, -0.3568220897730899, 0.9341723589627158)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
    ...
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            vertex_normals[4], Vector(0.9341723589627158, 0.0, 0.3568220897730899)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            vertex_normals[5], Vector(0.9341723589627158, 0.0, -0.3568220897730899)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
    ...
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            vertex_normals[7], Vector(0.3568220897730899, 0.9341723589627158, 0.0)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            vertex_normals[8], Vector(-0.3568220897730899, 0.9341723589627157, 0.0)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
    ...
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            vertex_normals[11], Vector(0.0, -0.3568220897730899, -0.9341723589627157)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            vertex_normals[12], Vector(0.0, 0.3568220897730899, -0.9341723589627158)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
    ...
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            vertex_normals[15], Vector(-0.3568220897730899, -0.9341723589627157, 0.0)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            vertex_normals[16], Vector(0.3568220897730899, -0.9341723589627158, 0.0)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
    ...
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            vertex_normals[18], Vector(-0.9341723589627157, 0.0, -0.3568220897730899)
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            vertex_normals[19], Vector(-0.9341723589627158, 0.0, 0.3568220897730899)
        )
    )
    ...
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            ...
            Vector(0.0, 0.3568220897730899, 0.9341723589627158),
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
    ...
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            ...
            Vector(0.9341723589627158, 0.0, 0.3568220897730899),
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
    ...
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            ...
            Vector(0.3568220897730899, 0.9341723589627158, 0.0),
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
    ...
    MINI_CHECK(
        TOLERANCE.is_vector_close(
            ...
            Vector(-0.3568220897730900, -0.9341723589627158, 0.0),
        )
    )
    MINI_CHECK(
        TOLERANCE.is_vector_close(
