...
def test_closest_line_point():
    ...
    cp1, t1, d1 = Closest.line_point(line, Point(5.0, 5.0, 0.0))
...
def test_closest_surface_curve():
    ...
    off = NurbsCurve.create(
        False, 1, [Point(20.0, 20.0, 20.0), Point(30.0, 30.0, 30.0)]
    )
