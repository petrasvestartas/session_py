...
def test_rtree_constructor():
    ...
    hits = tree.search([0.0, 0.0, 0.0], [1.0, 1.0, 1.0], callback)
...
def test_rtree_search_hit():
    ...
    hits = tree.search([1.0, 1.0, 1.0], [3.0, 3.0, 3.0], callback)
...
def test_rtree_search_miss():
    ...
    hits = tree.search([2.0, 2.0, 2.0], [3.0, 3.0, 3.0], lambda data: True)
...
def test_rtree_remove():
    ...
    removed = tree.remove([0.0, 0.0, 0.0], [1.0, 1.0, 1.0], 5)
...
def test_rtree_search_count():
    ...
    hits = tree.search([0.0, 0.0, 0.0], [4.0, 4.0, 4.0], lambda data: True)
...
def test_rtree_search_stop():
    ...
    hits = tree.search([0.0, 0.0, 0.0], [1.0, 1.0, 1.0], lambda data: False)
...
def test_rtree_normalizes_reversed_bounds():
    ...
    hits = tree.search([2.0, 3.0, 4.0], [-2.0, -3.0, -4.0], callback)

    removed = tree.remove([2.0, 3.0, 4.0], [-2.0, -3.0, -4.0], 9)
...
def test_rtree_search_100_boxes():
    ...
    for bounds in boxes:
        tree.insert(bounds[0:3], bounds[3:6], tree.count())
    ...
    hits = tree.search([-60.0, -60.0, -60.0], [60.0, 60.0, 60.0], callback)
