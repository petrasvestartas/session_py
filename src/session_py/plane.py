...
class Plane:
    ...
    def __init__(
        ...
        self._origin = Point()  # Origin point.
        self._x_axis = Vector.x_axis()  # Unit x axis.
        self._y_axis = Vector.y_axis()  # Unit y axis.
        self._z_axis = Vector.z_axis()  # Unit z axis.
        self._a = 0.0  # Plane equation coefficient a.
        self._b = 0.0  # Plane equation coefficient b.
        ...
        if point is not None:
            self._origin = Point(point[0], point[1], point[2])
    ...
    def __setitem__(self, index: int, value: Vector) -> None:
        """Set the axis by index (0=x, 1=y, 2=z)."""
    ...
    @classmethod
    def file_json_load(cls, filename: str | Path) -> Plane:
    ...
    # Protobuf
    # ═══════════════════════════════════════════════════════════════════════════
    def to_proto(self) -> plane_pb2.Plane:
    ...
    @classmethod
    def from_proto(cls, proto: plane_pb2.Plane) -> Plane:
    ...
    @classmethod
    def pb_load(cls, filename: str | Path) -> Plane:
